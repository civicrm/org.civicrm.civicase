 ...
 *
 * Generated from xml/schema/CRM/Civicase/CivicaseContactLock.xml
 * DO NOT EDIT.  Generated by CRM_Core_CodeGen
 * (GenCodeChecksum:db5bf4a479b00ab2f957675c14fbabcc)
 */

/**
 * Database access object for the CivicaseContactLock entity.
 */
class CRM_Civicase_DAO_CivicaseContactLock extends CRM_Core_DAO {
    ...
    if (!isset(Civi::$statics[__CLASS__]['fields'])) {
      Civi::$statics[__CLASS__]['fields'] = [
        'id' => [
          ...
          'description' => 'Unique CivicaseContactLock ID',
          'required' => TRUE,
          'table_name' => 'civicase_contactlock',
          'entity' => 'CivicaseContactLock',
          'bao' => 'CRM_Civicase_DAO_CivicaseContactLock',
          'localizable' => 0,
        ],
        'case_id' => [
          'name' => 'case_id',
