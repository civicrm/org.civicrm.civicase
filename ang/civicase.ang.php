...
// Add shoreditch custom css if not already present on the full page case screens
if (CRM_Utils_System::getUrlPath() == 'civicrm/case/a' && !civicrm_api3('Setting', 'getvalue', array('name' => "customCSSURL"))) {
